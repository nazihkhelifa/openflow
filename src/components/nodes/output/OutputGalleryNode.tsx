    ...
    <>
      ...
      >
        ...
        {displayImages.length === 0 ? (
          <div className="w-full flex-1 min-h-[200px] border border-dashed border-neutral-600 rounded flex flex-col items-center justify-center relative">
          ...
          <div className="flex-1 overflow-y-auto nodrag nopan nowheel relative">
            <div className="absolute bottom-2 left-2 z-10">
              <ConnectedImageThumbnails nodeId={id} />
            </div>
            <div className="absolute top-1 right-1 z-10">
              <MediaExpandButton
                nodeId={id}
                mediaUrls={displayImages}
                startIndex={lightboxIndex ?? 0}
                className="w-6 h-6 bg-black/60 hover:bg-black/80 text-white rounded flex items-center justify-center transition-colors"
              />
            </div>
