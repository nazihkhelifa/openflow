...
import { GenerateVideoToolbar } from "./GenerateVideoToolbar";
...
export function GenerateVideoNode({ id, data, selected }: NodeProps<GenerateVideoNodeType>) {
  ...
  // Auto-resize node to match generated video aspect ratio (like Upload node)
  ...
  <GenerateVideoToolbar
    ...
    >
      ...
      <div className="relative w-full h-full min-h-0 overflow-hidden rounded-2xl">
        ...
        {nodeData.outputVideo ? (
          <NodeVideoPlayer
            ...
            videoKey={nodeData.videoHistory?.[nodeData.selectedVideoHistoryIndex || 0]?.id}
            autoPlay
            loop
            muted
            objectFit="cover"
            ...
            loadingOverlay={
              nodeData.status === "loading" ? (
                <div className="absolute inset-0 bg-neutral-900/70 flex items-center justify-center z-30">
                ...
                <div className="absolute inset-0 bg-neutral-900/50 flex items-center justify-center z-30">
            ...
            errorOverlay={
              nodeData.status === "error" ? (
                <div className="absolute inset-0 bg-red-900/40 flex flex-col items-center justify-center gap-1 z-30">
        ...
        >
          {nodeData.outputVideo && hasCarouselVideos && (
