...
const MODELS_CACHE_KEY = "openflows-models-cache";
...
export function ModelSearchDialog({
  ...
  const handleRefresh = useCallback(async () => {
    ...
    try {
      ...
      localStorage.removeItem("openflows-schema-cache");
  ...
  const handleSelectModel = useCallback(
    (model: ProviderModel) => {
      ...
      const nodeType = isVideoModel ? "generateVideo" : is3DModel ? "generate3d" : isAudioModel ? "generateAudio" : "generateImage";
